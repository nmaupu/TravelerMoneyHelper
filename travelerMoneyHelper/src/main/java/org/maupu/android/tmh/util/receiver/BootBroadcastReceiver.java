...
public class BootBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (StaticData.PREF_DRIVE_AUTOMATIC_BACKUP_FREQ_NEVER != StaticData.getPreferenceValueInt(StaticData.PREF_DRIVE_AUTOMATIC_BACKUP_FREQ_KEY)
            ...
            builder
                    ...
                    .setContentText(amh.getNextAlarmDateTimeAsString());
